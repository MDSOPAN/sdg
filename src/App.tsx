...
function App() {
  ...
  return (
    <div className="relative">
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4 pb-4">
              <div className="flex flex-col space-y-4">
                ...
                <button className="bg-green-600 text-white px-6 py-2 rounded-full hover:bg-green-700 transition-colors w-fit">
                  Get Growing
                </button>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="p-6">
                ...
                <p className="text-gray-700">Less water than traditional farming (Noah would be proud)</p>
              </div>
              <div className="p-6">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <HowItWorksStep
              ...
              description="Easier than IKEA furniture, we promise! No mysterious leftover screws or existential crises included."
              delay={0}
            />
            <HowItWorksStep
              icon={Zap}
              step={2}
              title="Plug & Connect"
              description="Connect to power and WiFi. Your plants are about to become more connected than your teenager."
              delay={100}
            />
            <HowItWorksStep
              icon={Sprout}
            ...
            <HowItWorksStep
              ...
              description="Watch your garden grow and your grocery bills shrink. Victory tastes like fresh basil!"
              delay={300}
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <FeatureCard
              ...
              description="Water-based growing that's more efficient than a German engineer. Your plants will be swimming in nutrients, not drowning in confusion."
              delay={100}
            />
            <FeatureCard
              icon={Sun}
              title="LED Luminosity"
              description="Full-spectrum LED lights that give your plants the VIP treatment. It's like having the sun on speed dial, minus the sunburn."
              delay={200}
            />
            <FeatureCard
              icon={Settings}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-green-50 p-6 rounded-xl">
              ...
              <div className="text-green-700 font-semibold text-sm">- Chef wannabe Lisa</div>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <div className="text-blue-700 font-semibold text-sm">- Reformed plant killer Mike</div>
            </div>
            ...
            <div className="bg-purple-50 p-6 rounded-xl">
              ...
              <div className="text-purple-700 font-semibold text-sm">- Wizard mom Jennifer</div>
            </div>
            ...
            <div className="bg-yellow-50 p-6 rounded-xl">
              ...
              <div className="text-yellow-700 font-semibold text-sm">- Influencer David</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <ParallaxSection
        backgroundImage="https://images.pexels.com/photos/1002703/pexels-photo-1002703.jpeg"
        speed={0.3}
        overlay={true}
        className="flex items-center justify-center"
      >
        <div className="container mx-auto px-6 text-center text-white">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white bg-opacity-20 backdrop-blur-md p-8 rounded-xl">
              ...
              <div className="text-green-400 font-semibold">- Sarah, Former Plant Assassin</div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur-md p-8 rounded-xl">
              ...
              <div className="text-green-400 font-semibold">- Marcus, Urban Farmer</div>
            </div>
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur-md p-8 rounded-xl">
              ...
              <div className="text-green-400 font-semibold">- Emma, Tech Enthusiast</div>
            </div>
          </div>
        </div>
      </ParallaxSection>
      ...
      <section className="py-20 bg-green-600">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="space-y-6 md:space-y-0 md:flex md:justify-center md:space-x-6">
            <button className="bg-white text-green-600 px-10 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-xl w-full md:w-auto">
              Start Growing Today
            </button>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Growing Guides</a></li>
              </ul>
            </div>
